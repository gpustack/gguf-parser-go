...
+-------+--------------+--------------------+-----------------+-----------+----------------+---------------+----------------+----------------+--------+------------+------------+--------+----------+-----------+--------+-----------+-----------+--------+-----------+-----------+--------+----------+----------+
| llama |     1024     |     2048 / 512     |     Disabled    |  Enabled  |       No       |   Supported   |   81 (80 + 1)  |       Yes      |    0   | 302.08 MiB | 452.08 MiB |   18   | 9.93 GiB | 10.17 GiB |   22   | 10.62 GiB | 10.78 GiB |   27   | 12.95 GiB | 13.08 GiB | 13 + 1 | 6.72 GiB | 7.71 GiB |
+-------+--------------+--------------------+-----------------+-----------+----------------+---------------+----------------+----------------+--------+------------+------------+--------+----------+-----------+--------+-----------+-----------+--------+-----------+-----------+--------+----------+----------+
...
| host1 (NVIDIA 4080 1) |               |             | 10 GiB         | 10.78 GiB    |            |
| host2 (NVIDIA 4090)   |               |             | 12 GiB         | 13.08 GiB    |            |
| host3 (Apple M1 Max)  | ENOUGH        |             | 6 GiB          | 6.72 GiB     |            |
...
+-------+--------------+--------------------+-----------------+-----------+----------------+---------------+----------------+----------------+--------+------------+------------+--------+--------+----------+--------+----------+----------+--------+-----------+-----------+--------+----------+----------+--------+----------+----------+
| llama |     1024     |     2048 / 512     |     Disabled    |  Enabled  |       No       |   Supported   |   81 (80 + 1)  |       Yes      |    0   | 318.08 MiB | 468.08 MiB |   11   | 44 MiB | 6.88 GiB |   18   | 8.70 GiB | 8.87 GiB |   21   | 10.11 GiB | 10.27 GiB |   13   | 6.31 GiB | 6.51 GiB | 17 + 1 | 8.64 GiB | 9.63 GiB |
+-------+--------------+--------------------+-----------------+-----------+----------------+---------------+----------------+----------------+--------+------------+------------+--------+--------+----------+--------+----------+----------+--------+-----------+-----------+--------+----------+----------+--------+----------+----------+
...
| host4                 | 11 GiB        | 8.87 GiB    |                |              | :thumbsup: |
| host1 (NVIDIA 4080 1) |               |             | 12 GiB         | 10.27 GiB    | :thumbsup: |
| host2 (NVIDIA 4080 0) |               |             | 8 GiB          | 6.51 GiB     | :thumbsup: |
| host3 (NVIDIA 4080 1) |               |             | 10 GiB         | 9.63 GiB     | :thumbsup: |
